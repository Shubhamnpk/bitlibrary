    ...
    <div className="animate-fade-in pb-28 pt-4 md:pb-32 md:pt-6">
      <div className="mx-auto max-w-6xl">
        <article className="space-y-8 md:space-y-12">
          <section className="relative overflow-hidden rounded-[2.75rem] border border-white/5 bg-[linear-gradient(160deg,rgba(255,255,255,0.05),rgba(255,255,255,0.015))] px-6 py-10 shadow-[0_24px_80px_rgba(0,0,0,0.28)] md:px-12 md:py-16">
            ...
            <div className="absolute right-0 top-0 h-72 w-72 bg-[radial-gradient(circle,rgba(255,255,255,0.09),transparent_60%)] pointer-events-none" />
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div className="max-w-3xl">
                ...
                <h1 className="max-w-4xl text-5xl font-display font-bold leading-[0.94] tracking-tight text-white md:text-7xl">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <div className="inline-flex rounded-full border border-white/10 bg-black/20 px-4 py-2 text-[11px] font-mono uppercase tracking-[0.2em] text-gray-300">
                    Community made
                  </div>
                  <div className="inline-flex rounded-full border border-white/10 bg-black/20 px-4 py-2 text-[11px] font-mono uppercase tracking-[0.2em] text-gray-300">
                    Education focused
              ...
              <div className="relative mx-auto w-full max-w-lg">
                <div className="grid gap-4">
                  <div className="overflow-hidden rounded-[2.25rem] border border-white/10 bg-black/20 p-6 backdrop-blur-sm md:p-7">
                    <div className="flex items-center justify-between">
                      <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[10px] font-mono uppercase tracking-[0.2em] text-gray-300">
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-3">
                      {trustPoints.map((item) => (
                        <div key={item.label} className="rounded-[1.35rem] border border-white/10 bg-white/[0.03] p-4">
                          ...
                          <p className="mt-2 text-sm font-display font-bold leading-6 text-white">{item.value}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {visualMoments.map((item, index) => {
                      ...
                      return (
                        <div key={item.title} className={`relative overflow-hidden rounded-[2rem] border border-white/10 p-5 ${index === 0 ? 'bg-[linear-gradient(160deg,rgba(var(--bit-accent-rgb),0.14),rgba(255,255,255,0.03))]' : 'bg-[linear-gradient(160deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))]'}`}>
                          <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full border border-white/10 opacity-40" />
                          <div className="relative">
                            <div className="flex h-12 w-12 items-center justify-center rounded-[1rem] border border-white/10 bg-black/20 text-bit-accent">
                              <Icon size={20} />
                            </div>
                            <h3 className="mt-8 text-2xl font-display font-bold text-white">{item.title}</h3>
          ...
          <section className="grid gap-5 md:grid-cols-3 md:gap-6">
            {valueCards.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-[2rem] border border-white/5 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-7 transition-all hover:-translate-y-1 hover:border-bit-accent/20"
                >
          ...
          <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[2.25rem] border border-white/5 bg-white/[0.02] p-7 md:p-10">
            ...
            <div className="grid gap-4">
              <div className="rounded-[2.25rem] border border-bit-accent/15 bg-[linear-gradient(180deg,rgba(var(--bit-accent-rgb),0.12),rgba(255,255,255,0.02))] p-7 md:p-10">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {simplePromises.map((item) => (
                  <div key={item} className="rounded-[1.5rem] border border-white/10 bg-black/20 px-4 py-5 text-sm leading-7 text-gray-300">
                    {item}
                  </div>
                ))}
              </div>
          ...
          <section className="grid gap-6 md:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-[2.25rem] border border-white/5 bg-white/[0.02] p-7 md:p-10">
              <p className="text-[10px] font-mono uppercase tracking-[0.24em] text-gray-500">Open community</p>
              <h2 className="mt-4 text-3xl font-display font-bold text-white">Built with community spirit.</h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.75rem] border border-white/5 bg-white/[0.02] p-6">
          ...
          <section className="rounded-[2.5rem] border border-white/5 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.015))] px-6 py-10 md:px-10 md:py-12">
            ...
            <div className="mt-8 grid gap-4 md:mt-10 md:grid-cols-2">
              {quickAnswers.map((item) => (
                <div key={item.question} className="rounded-[1.75rem] border border-white/5 bg-black/20 p-6 transition-colors hover:border-white/10">
          ...
          <section className="rounded-[2.5rem] border border-bit-accent/20 bg-[linear-gradient(135deg,rgba(var(--bit-accent-rgb),0.14),rgba(255,255,255,0.02))] px-8 py-12 text-center md:px-12 md:py-14">
            <div className="mx-auto max-w-3xl">
              ...
              <h2 className="mt-6 text-3xl font-display font-bold text-white md:text-4xl">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/20 px-4 py-2 text-[11px] font-mono uppercase tracking-[0.2em] text-gray-300">
